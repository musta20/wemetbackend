...
export default function Terms() {
  return (
    <Box m={10} textAlign={"justify"}>
      <div>
        <Text fontSize={"3xl"}>Wemet Terms of Service Agreement</Text>
      </div>
      <br></br>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to weemeet.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to weemeet, accessible from
            <a
              href="https://www.wemet.live"
              rel="noopener noreferrer"
              target="_blank"
            >
              https://www.wemet.live
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.wemet.live/contact"
            rel="noopener noreferrer"
            target="_blank"
          >
            https://www.wemet.live/contact
          </a>
        </li>
      </ul>
    </Box>
